...
print(f'Diretório para banco de dados GAMEBASE{dir_absp}data/database.db')
...
def adicionar_games_bd(game, diretório):
    ...
    game = Game(game_name=f'{game}', directory=f'{diretório}')
...
#adicionar_games_bd(str('teste'), str('teste'))
